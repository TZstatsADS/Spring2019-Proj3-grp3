...
```{r wkdir, eval=FALSE}
#setwd("../Spring2019-Proj3-spring2019-proj3-grp3/data")
...
#save(fit_train, file="../output/fit_train_demo.RData")
```
...
test_dir <- "../data/test_set_demo/" # This will be modified for different data sets.
